...
<div class="header high">
    ...
    <h2>
        ...
        Branches: <span class="metric">85.96% <small>(49 / 57)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-yes">66</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var strxml = require('strxml'),
    tag = strxml.tag,
...
&nbsp;
function iconUrl(_) {
    var size = _['marker-size'] || <span class="branch-1 cbranch-no" title="branch not covered" >'medium',</span>
        symbol = _['marker-symbol'] ? '-' + _['marker-symbol'] : <span class="branch-1 cbranch-no" title="branch not covered" >'',</span>
        color = (_['marker-color'] || <span class="branch-1 cbranch-no" title="branch not covered" >'7e7e7e')</span>.replace('#', '');
&nbsp;
...
&nbsp;
function hasStyle(_) {
    return !!(_['marker-size'] || <span class="branch-1 cbranch-no" title="branch not covered" >_['marker-symbol'] </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >_['marker-color'])</span>;
}
&nbsp;
function iconHash(_) {
    return (_['marker-symbol'] || <span class="branch-1 cbranch-no" title="branch not covered" >'')</span> +
        (_['marker-color'] || <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>.replace('#', '') +
        (_['marker-size'] || <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>;
}
&nbsp;
// ## Helpers
function pairs(_) {
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Fri Mar 20 2015 14:05:18 GMT-0400 (EDT)</div>
</div>
